...
const NAV = [
   ...
   */
  {
    ...
    itens: [
      ...
      { arquivo: 'sidebar.html', rotulo: 'Sidebar' },
      { arquivo: 'sidebar-group.html', rotulo: 'Sidebar Group' },
      { arquivo: 'sidebar-item.html', rotulo: 'Sidebar Item' },
      { arquivo: 'sidebar-label.html', rotulo: 'Sidebar Label' },
...
const TOKENS = [
  ...
  ['--lc-color-shell-fill', 'o casco escuro da aplicação — a barra lateral'],
  ['--lc-color-shell-text', 'texto sobre o casco'],
  ['--lc-color-shell-accent', 'a marca do item atual, sobre o casco'],
